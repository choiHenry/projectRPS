...
def train(args):
  ...
  dataset_train = CustomDataset(args.train_dir, transform=transform, train=True)
  # num_train = len(dataset_train['input'])
  ...
  dataset_val = CustomDataset(args.val_dir, transform=transform, train=False)
  # num_val = len(dataset_val['input'])
